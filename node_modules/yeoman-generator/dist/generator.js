    ...
    destinationRoot(rootPath) {
        if (typeof rootPath === 'string') {
            ...
            if ('getContextMap' in this.env) {
                this._contextMap = this.env.getContextMap(this._destinationRoot);
            }
