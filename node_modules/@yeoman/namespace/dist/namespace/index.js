...
function nextTokenIndex(value, start, tokens) {
...
function parseNamespace(complete) {
    ...
    let cursor = 0;
    const parsed = { complete, unscoped: '' };
...
export function requireNamespace(namespace, options = {}) {
...
export function hasGenerator(value) {
